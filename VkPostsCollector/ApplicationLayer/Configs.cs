...
namespace VkPostsCollector.ApplicationLayer
{
    public static class Configs
    {
        ...
        public static string TelegramToken { get; set; } = "5468820716:AAHptmrUm0Rx4NzdAGvWzC5lxMDpDv9_LPk"; // Токен бота в телеге
        public static string AdLink { get; set; } = "https://alitems.com/g/1e8d114494bd0482fb1316525dc3e8/";
        public static string TelegramChannel { get; set; } = "https://t.me/jenskaya_cloth";
